...
const translations = {
    en: {
        ...
        // Pages
        'page.allTransactions': 'All Hashes',
        ...
        'batchDetail.totalTxs': 'Total Hashes',
        ...
        'batchDetail.txsInBatch': 'Hashes in this Batch',
        'batchDetail.showing': 'Showing',
        'batchDetail.ofTxs': 'hashes in batch',
    ...
    zh: {
        ...
        'batchDetail.txsInBatch': '批次内哈希',
        'batchDetail.showing': '显示',
        'batchDetail.ofTxs': '个哈希，批次',
        ...
        'blockDetail.txCount': '哈希数',
        'blockDetail.gasUsed': 'Gas消耗',
        'blockDetail.gasLimit': 'Gas上限',
        'blockDetail.validator': '验证者',
        'blockDetail.txsInBlock': '区块内哈希',
        
        // Address Page
        'address.overview': '概览',
        'address.txCount': '哈希数',
        'address.volume': '总交易量',
        'address.firstTx': '首个哈希',
        'address.lastTx': '最近哈希',
        'address.balance': '余额',
        'address.pnl': '已实现盈亏',
        'address.txHistory': '哈希历史',
