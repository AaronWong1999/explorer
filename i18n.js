...
const translations = {
    ...
    zh: {
        ...
        // Search
        'search.placeholder': '搜索事务 / 地址 / 批次ID',
        'search.button': '搜索',
        ...
        // Pages
        'page.allTransactions': '全部事务',
        'page.allBatches': '全部批次',
        'page.allBlocks': '全部区块',
        'page.transactionDetails': '事务详情',
        ...
        'batchDetail.txsInBatch': '批次内事务',
        'batchDetail.showing': '显示',
        'batchDetail.ofTxs': '个事务，批次',
        ...
        'blockDetail.txCount': '事务数',
        'blockDetail.gasUsed': 'Gas消耗',
        'blockDetail.gasLimit': 'Gas上限',
        'blockDetail.validator': '验证者',
        'blockDetail.txsInBlock': '区块内事务',
        
        // Address Page
        'address.overview': '概览',
        'address.txCount': '事务数',
        'address.volume': '总交易量',
        'address.firstTx': '首个事务',
        'address.lastTx': '最近事务',
        'address.balance': '余额',
        'address.pnl': '已实现盈亏',
        'address.txHistory': '事务历史',
